...
class DaoPolygon:
    ...
    def __init__(self, polygon):
        ...
        Args:
            polygon (list): [polygon_id, layer, vertex_num, <str>vertices]
        """
    ...
    def add_child(self, child):
        ...
        Args:
            child (DaoPolygon): child DaoPolygon
        """
    ...
    def to_list(self):
        ...
        Returns:
            return (list): [polygon_id, layer, vertex_num, <str>vertices]
        """
    ...
    def add_vertex(self, x, y, v_id=-1):
        ...
        Args:
            x (int): 新点 x 坐标
            y (int): 新点 x 坐标
            v_id (int): 新点插入位置，原 v_id 对应点后移。若 v_id 为负，则插入到最后。
        """
        if v_id >= 0:
            # 从中间插入点
    ...
    def traversal_post_order(self):
        ...
        Returns:
            return (list): list of 后续遍历得到的多边形索引
        """
        deleted_id = []
